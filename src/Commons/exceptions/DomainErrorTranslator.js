...
DomainErrorTranslator._directories = {
  ...
  'AUTHENTICATION.UNAUTHORIZED_USER': new AuthenticationError('kredensial yang Anda masukkan salah'),
  ...
  'THREAD_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('method not implemented'),
  'COMMENT_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('method not implemented'),
  'REPLY_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('method not implemented'),
  ...
  'AUTHENTICATION.FORBIDDEN_USER': new AuthorizationError('Anda tidak berhak mengakses resource ini'),
};
